...
public class InsertData extends Transaction {
	...
	public ExecutionHistory execute() {
		try {
			...
			int[] randCustomerId = new int[NUMBER_OF_CUSTOMER]; // random permutation of 3k customer IDs, used while creating Order org.imdea.benchmark.rubis.table
...
//			for(i=1; i<=this.NumberWarhouse; i++){			
			...
			int i=NumberWarhouse;
				...
				create(wh);
				/*each warehouse has 100,000 rows in the STOCK org.imdea.benchmark.rubis.table*/
