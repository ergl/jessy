...
public class RUBiSProperties {
    ...
    public RUBiSProperties() {
        ...
        System.out.println("Looking for rubis.properties in classpath (" + System.getProperty("java.class.path", ".")
                + ")<p>");
        try {
    ...
    public RUBiSProperties(String filename) {
        // Get and check database.properties
        System.out.println("Looking for " + filename + ".properties in classpath (" + System.getProperty("java.class" +
                ".path", ".") + ")<p>");
        try {
    ...
    public void checkPropertiesFileAndGetURLGenerator() {
        try {
            ...
            BufferedReader categoriesReader = new BufferedReader(new FileReader(getProperty
                    ("database_categories_file")));
    ...
    /**
     * Return an array of number of items per category as described in the categories file given in the
    ...
    /**
     * Get the total number of items computed from information found in the categories file given in the
     * categories_file field
     *
