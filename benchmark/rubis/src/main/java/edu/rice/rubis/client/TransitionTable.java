 ...
 * Home                     [tab]probability_1_1[tab]probability_2_1[tab]...[tab]probability_27_1[tab
 * ]transition_waiting_time
 * Register                 [tab]probability_1_2[tab]probability_2_2[tab]...[tab]probability_27_2[tab
 * ]transition_waiting_time
 * RegisterUser             [tab]probability_1_3[tab]probability_2_3[tab]...[tab]probability_27_3[tab
 * ]transition_waiting_time
 * Browse                   [tab]probability_1_4[tab]probability_2_4[tab]...[tab]probability_27_4[tab
 * ]transition_waiting_time
 * BrowseCategories         [tab]probability_1_5[tab]probability_2_5[tab]...[tab]probability_27_5[tab
 * ]transition_waiting_time
 * SearchItemsInCategory    [tab]probability_1_6[tab]probability_2_6[tab]...[tab]probability_27_6[tab
 * ]transition_waiting_time
 * BrowseRegions            [tab]probability_1_7[tab]probability_2_7[tab]...[tab]probability_27_7[tab
 * ]transition_waiting_time
 * BrowseCategoriesInRegion [tab]probability_1_8[tab]probability_2_8[tab]...[tab]probability_27_8[tab
 * ]transition_waiting_time
 * SearchItemsInRegion      [tab]probability_1_9[tab]probability_2_9[tab]...[tab]probability_27_9[tab
 * ]transition_waiting_time
 * ViewItem                 [tab]probability_1_10[tab]probability_2_10[tab]...[tab]probability_27_10[tab
 * ]transition_waiting_time
 * ViewUserInfo             [tab]probability_1_11[tab]probability_2_11[tab]...[tab]probability_27_11[tab
 * ]transition_waiting_time
 * ViewBidHistory           [tab]probability_1_12[tab]probability_2_12[tab]...[tab]probability_27_12[tab
 * ]transition_waiting_time
 * BuyNowAuth               [tab]probability_1_13[tab]probability_2_13[tab]...[tab]probability_27_13[tab
 * ]transition_waiting_time
 * BuyNow                   [tab]probability_1_14[tab]probability_2_14[tab]...[tab]probability_27_14[tab
 * ]transition_waiting_time
 * StoreBuyBow              [tab]probability_1_15[tab]probability_2_15[tab]...[tab]probability_27_15[tab
 * ]transition_waiting_time
 * PutBidAuth               [tab]probability_1_16[tab]probability_2_16[tab]...[tab]probability_27_16[tab
 * ]transition_waiting_time
 * PutBid                   [tab]probability_1_17[tab]probability_2_17[tab]...[tab]probability_27_17[tab
 * ]transition_waiting_time
 * StoreBid                 [tab]probability_1_18[tab]probability_2_18[tab]...[tab]probability_27_18[tab
 * ]transition_waiting_time
 * PutCommentAuth           [tab]probability_1_27[tab]probability_2_19[tab]...[tab]probability_27_19[tab
 * ]transition_waiting_time
 * PutComment               [tab]probability_1_20[tab]probability_2_20[tab]...[tab]probability_27_20[tab
 * ]transition_waiting_time
 * StoreComment             [tab]probability_1_21[tab]probability_2_21[tab]...[tab]probability_27_21[tab
 * ]transition_waiting_time
 * Sell                     [tab]probability_1_22[tab]probability_2_22[tab]...[tab]probability_27_22[tab
 * ]transition_waiting_time
 * SelectCategoryToSellItem [tab]probability_1_23[tab]probability_2_23[tab]...[tab]probability_27_23[tab
 * ]transition_waiting_time
 * SellItemForm             [tab]probability_1_24[tab]probability_2_24[tab]...[tab]probability_27_24[tab
 * ]transition_waiting_time
 * RegisterItem             [tab]probability_1_25[tab]probability_2_25[tab]...[tab]probability_27_25[tab
 * ]transition_waiting_time
 * AboutMe (auth form)      [tab]probability_1_26[tab]probability_2_26[tab]...[tab]probability_27_26[tab
 * ]transition_waiting_time
 * AboutMe                  [tab]probability_1_27[tab]probability_2_27[tab]...[tab]probability_27_27[tab
 * ]transition_waiting_time
 * Back probability         [tab]probability_1_28[tab]probability_2_28[tab]...[tab]probability_27_28[tab
 * ]transition_waiting_time
 * End of Session           [tab]probability_1_29[tab]probability_2_29[tab]...[tab]probability_27_29[tab
 * ]transition_waiting_time
 * ...
 *
 * </pre>
...
public class TransitionTable {
     ...
     */
    public TransitionTable(int columns, int rows) {
        nbColumns = columns;
        nbRows = rows;
    ...
    public int nextState() {
        ...
        if (currentState == nbRows - 2) {
            if (previousStates.empty()) {
                System.out.println("Error detected: Trying to go back but no previous state is available " +
                        "(currentState:" + currentState + ", beforeStep:" + beforeStep);
            } else {
                currentState = previousStates.pop();
                return currentState;
            }
            ...
            if (!isEndOfSession()) {
                ...
                if (transitions[currentState][nbRows - 2] == 0) {
                    ...
                    previousStates.push(beforeStep);
                }
            }
        }
    ...
    public boolean readExcelTextFile(String filename) {
        ...
        try {
            ...
            System.err.println("Number format error in file " + filename + " when reading line " + i + ", column " +
                    j + ". (" + ne.getMessage() + ")");
            return false;
        }
