...
public abstract class SSIPSI extends Consistency {
    /**
     ...
     */
    public static final String LEVEL = SSIPSI.class.getName() + "::LEVEL";
     ...
     * Log information.
     */
    protected static Logger logger = Logger.getLogger(SSIPSI.class);
     ...
     */
    public SSIPSI(JessyGroupManager m, DataStore s) {
        super(m, s);
    }
